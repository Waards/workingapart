...
import { Building2, LayoutDashboard, DollarSign, Wrench, MessageSquare, Settings, LogOut, Menu, X } from "lucide-react"
import { useToast } from "@/hooks/use-toast"

const navigation = [
  { name: "Dashboard", href: "/tenant/dashboard", icon: LayoutDashboard },
  { name: "Rent Status", href: "/tenant/rent", icon: DollarSign },
